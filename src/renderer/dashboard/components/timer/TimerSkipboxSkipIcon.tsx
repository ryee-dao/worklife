...
export default function TimerSkipboxSkipIcon({ slashed }: TimerSkipboxSkipIconProps) {
    return (
        <div data-testid="timer-skip-icon" className={`relative self-center rounded-full h-4/5 lg:h-5/6 aspect-square border sm:border-2 ${slashed ? 'bg-slate-200 used-skip' : 'bg-blue-200'}`}>
